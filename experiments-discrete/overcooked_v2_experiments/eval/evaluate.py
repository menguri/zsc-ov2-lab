...
def visualize_pairing(
    ...
    runs = eval_pairing(
        policies, layout_name, key, env_kwargs, num_seeds, all_recipes, no_viz, algorithm=algorithm, ego_direction=ego_direction, ov_type=ov_type
    )
...
def eval_pairing(
    ...
    if all_recipes:
        ...
        def _rollout_recipe(recipe):
            ...
            rollout = get_rollout(policies, env, key, algorithm=algorithm, ego_direction=ego_direction, ov_type=ov_type)
